...
import ModR from "./pages/Modules/Mod_R";
  ...
  createRoutesFromElements(
    <Route path="/" element={<Navbar />}>
      ...
      <Route path="modules" element={<ModsLayout />}>
        ...
        <Route path="mod2" element={<ModR />} />
        <Route path="mod3" element={<Mod2 />} />
        <Route path="mod4" element={<Mod3 />} />
        <Route path="mod5" element={<Mod4 />} />
        <Route path="mod6" element={<Mod5 />} />
        <Route path="mod7" element={<Mod6 />} />
        <Route path="mod8" element={<Mod7 />} />
        <Route path="mod9" element={<Mod8 />} />
      </Route>
