    ...
    <div>
      ...
      <div className="main-about">
        <div class="about-card">
          ...
          <p class="job">
            Sheida is the Principal Investigator whose primary ....
          </p>
          <div class="share">
            <button class="btn11">
              <svg
        ...
        <div class="about-card">
          ...
          <p class="job">Samson is a PhD Candidate who ...</p>
          <div class="share">
            <button class="btn11">
              <svg
                fill-rule="nonzero"
        ...
        <div class="about-card">
          <div class="card-border-top"></div>
          <div class="img">
            <img src="./images/profile_pictures/hari_pic.png" alt="Hari" />
          </div>
          <span>Hari Patchigolla</span>
          <p class="job">
            Hari is an Undergraduate Research Assistant that ...
          </p>
          <div class="share">
            <button class="btn11">
              <svg
        ...
        <div class="about-card">
          ...
          <p class="job">
            Lana is an Undergraduate Research Assistant where she ...
          </p>
          <div class="share">
            <button class="btn11">
              <svg
